/**************************************************************************************************************************
* File: NvidiaGraphicsCards.h
* 
* Original Author: Anthony Alexander
* 
* Summary:	Graphics card driver header file for Nvidia based graphics cards. Uses Nvidia's NVAPI library for common 
*			functionality for all Nvidia based graphics cards. This driver is built under .clr so it is can be used with 
*			any .NET developed application. This driver gets the various hardware settings and performance to allow
*			an application to report the graphics card performance.
* 
* Date:			Author:				Description of Change:
* 12/24/2020	Anthony Alexander	Initial Creation
***************************************************************************************************************************/
...
{
	/// <summary>
	/// NvidiaGraphicsCard Class
	/// Utilizes Nvidia's NVAPI library to create communication between Windows applications
	/// and the Nvidia graphics cards. Class is can be used common with all types of Nvidia
	/// Graphics cards.
	/// </summary>
	public ref class NvidiaGraphicsCard : IGraphicsCard
	{
		//****************************************************************************
		...
		public:
			...
			/// <summary>
			/// Constructor for NvidiaGraphicsCard object
			/// </summary>
			NvidiaGraphicsCard();

			/// <summary>
			/// Destructor for NvidiaGraphicsCard object
			/// </summary>
			~NvidiaGraphicsCard();
